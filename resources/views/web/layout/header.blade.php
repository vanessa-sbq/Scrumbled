        ...
        <div class="relative inline-block text-left">
            <div>
                <button type="button"
                    ...
                    id="trigger" aria-expanded="true" aria-haspopup="true">
                    @if (Auth::user()->picture)
                        <img class="h-12 w-12 rounded-full"
                            src="{{ asset(Auth::user()->picture ? 'storage/' . Auth::user()->picture : 'images/users/default.png') }}"
                            alt="Profile Picture">
                    @else
                        <img class="h-12 w-12 rounded-full" src="{{ asset('images/users/default.png') }}"
                            alt="Profile Picture">
                    @endif
            ...
            <div id="dropdown"
                ...
                <a href="{{ route('show.profile', Auth::user()->username) }}"
                    class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-0">My
                    Profile</a>
