<div class="flex flex-col -mt-2 mb-6">
    ...
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-2 text-gray-600">
            ...
            <span>/</span>
            <a href="{{ route('sprints', $project->slug) }}" class="font-bold hover:underline">sprints</a>
            @if (isset($sprint))
                <span>/</span>
                <a href="{{ route('sprint.show', $sprint->id ) }}" class="font-bold hover:underline">{{ $sprint->id }}</a>
            @endif
        </div>
        <div class="flex space-x-4">
            ...
            <a href="{{ route('sprints', $project->slug) }}"
               class="{{ request()->routeIs('sprints') || request()->routeIs('sprint.show') ? 'text-primary font-bold' : 'text-primary hover:underline' }}">Sprints</a>
