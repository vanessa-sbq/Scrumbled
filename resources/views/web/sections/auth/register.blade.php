    ...
    <div class="container mx-auto py-8">
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input id="username" type="text" name="username" value="{{ old('username') }}" placeholder="Enter your username"
                       required autofocus
            ...
            <div class="mb-4">
                ...
                <input id="full_name" type="text" name="full_name" value="{{ old('full_name') }}" placeholder="Enter your full name"
                       class="mt-1 block w-full px-3 py-2 border border-muted rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
